/**Classe para objeto do tipo ProdutoDAO, onde serão contidos, métodos e valores para os mesmos.
...
public class ProdutoDAO {
    ...
    /** Método para instaciar a classe ProdutoDAO.*/
    public ProdutoDAO(){
        conn = new ConnectionFactory().getConexao();
    }
    /** Método para inserção de dados na base de dados mercado.*/
    ...
    /** Método para edição de dados na base de dados mercado.*/
    ...
    /** Método para exclusão de dados na base de dados mercado.*/
    ...
    /** Método de criação de um objeto do tipo ArrayList para armazenar e listar os dados contidos na base
     * de dados mercado.*/
